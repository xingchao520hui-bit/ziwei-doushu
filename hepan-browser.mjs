...
const EMBEDDED_RULE_PACK = {
  "id": "compat/v1",
  "life_rhythm": {
    "enabled": true,
    "years": 10
  },
  "branch_relation_scores": {
    "same": 1.0,
    "liuhe": 0.88,
    "sanhe": 0.82,
    "neutral": 0.52,
  ...
  "penalty_cap": 8,
  "weights": {
    "palace_alignment": 0.25,
    "star_harmony": 0.38,
    "mutagen_interaction": 0.25,
    "life_rhythm": 0.12
  },
  "dimension_caps": {
    "palace_alignment": 25,
    "star_harmony": 38,
    "mutagen_interaction": 25,
    "life_rhythm": 12
  },
  "palace_checks": [
    {
  ...
  "mutagen_rules": [
    {
      "id": "MJ001",
      "type": "both_spouse_have_ji",
      "points": -5,
      "description": "双方夫妻宫均见化忌星"
    },
    {
      "id": "MJ002",
      "type": "fude_lu",
      "points": 3,
      "description": "任一方福德宫见化禄"
    },
    {
      "id": "MJ003",
      "type": "ming_ke",
      "points": 2,
      "description": "任一方命宫见化科（相处上的协调加分）"
    }
  ]
}
;
const EMBEDDED_GROUPINGS = {
  "default": "杂曜",
  "右弼": "辅星",
  "左辅": "辅星",
  "文昌": "昌曲",
